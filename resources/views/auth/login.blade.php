@extends('layout.master-without-nav')k
@section('title')
                            ...
                            <div class="p-2 mt-4">
                                <form action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" required value="" id="username" name="email" placeholder="Enter email">
                                    </div>
...
{{--                                        </div>--}}
                                        ...
                                        <div class="position-relative auth-pass-inputgroup mb-3">
                                            <input type="password" class="form-control pe-5" required name="password" placeholder="Enter password" id="password-input" value="">
